...
ANALYST_CONFIGS: Dict[str, Dict[str, str]] = {
    ...
    "REX": {
        ...
        "personality": (
            ...
            f"  Step 5 — Cap: if position_usd > ${PORTFOLIO_SIZE * 0.20:,.0f} (20% of portfolio), "
            f"reduce units proportionally so position_usd = ${PORTFOLIO_SIZE * 0.20:,.0f}\n"
            ...
            f"    Capped at 20% → position = ${PORTFOLIO_SIZE * 0.20:,.0f} (1.77x reduced to 0.30 units)\n"
            f"    Size = 20.0% (${PORTFOLIO_SIZE * 0.20:,.0f})\n"
...
class Analyst:
    ...
    def _build_system_prompt(
        ...
        rules = (
            ...
            f"   - Cap position at 20% of portfolio max (${PORTFOLIO_SIZE * 0.20:,.0f}); reduce units proportionally if needed\n"
