...
**LESSONS LEARNED** — 3–5 specific, actionable lessons for future {symbol.upper()} analysis.
**BIAS WATCH** — Any systematic team-wide biases to guard against (groupthink, confirmation bias, directional herding)?
